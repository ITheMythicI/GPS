...
if (!$db) {
    echo json_encode(['status' => 'error', 'message' => 'Error interno: No se pudo conectar a la base de datos.']);
    exit;
}
...
if ($stmt_insert) {
    ...
    if (mysqli_stmt_execute($stmt_insert)) {
        ...
        echo json_encode(['status' => 'error', 'message' => 'Error al guardar en la base de datos: ' . mysqli_stmt_error($stmt_insert)]);
    }
